...
export class UsersController {
  ...
  @Roles(ROLE.ADMIN)
  @Post('roles')
  createRole(@Body() body: { name: string; description?: string }, @CurrentUser() user: AccessTokenPayload) {
  ...
  @Roles(ROLE.ADMIN)
  @Delete('roles/:roleId')
  deleteRole(@Param('roleId') roleId: string, @CurrentUser() user: AccessTokenPayload) {
  ...
  @Roles(ROLE.ADMIN)
  @Patch(':id')
  updateUser(@Param('id') id: string, @Body() body: UpdateUserDto, @CurrentUser() currentUser: AccessTokenPayload) {
  ...
  @Roles(ROLE.ADMIN)
  @Delete(':id')
  deleteUser(@Param('id') id: string, @CurrentUser() currentUser: AccessTokenPayload) {
